...
**产品名：** Palimpsest · 叠简  
**选定：** 2026-08-12  
**一句话：** 把长篇小说收成可以 git、可以换 Agent、设定可追溯的工程文件夹。

主张与架构铁则的真源是仓库根目录 [`README.md`](../README.md) 与 [`AGENTS.md`](../AGENTS.md) §0。本文只记录方向选定与范围，不另立一套原则。

---

## 1. 我们做什么

为认真写长篇（或深改写 / 续写）的人，提供：

1. 一书一文件夹（`00`–`09`）  
2. 对这份数据可重复执行的指令（ingest → parse → continue / rewrite → review → export）  
3. 给 Coding Agent 的强制规约  

阅读器、ST / EPUB 导出是指令的一种，不是平行产品。
